...
namespace SearchPracticeNETv7.Migrations
{
    ...
    [Migration("20230930042043_Setup")]
    partial class Setup
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SearchPracticeNETv7.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("SearchPracticeNETv7.Models.Month", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("SearchPracticeNETv7.Models.AppUser", null)
                        .WithMany()
